...
class Originator
{
    ...
    {
        assert($memento instanceof ConcreteMemento);

        if (!$memento instanceof ConcreteMemento) {
            throw new \InvalidArgumentException('Invalid memento');
        }
...
interface Memento
{
    // public function getState(): string;  // wrong solution, broken pattern!
